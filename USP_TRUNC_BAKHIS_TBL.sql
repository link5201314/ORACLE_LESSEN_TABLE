CREATE OR REPLACE PROCEDURE TRW.USP_TRUNC_BAKHIS_TBL(
...
CREATE OR REPLACE PROCEDURE TRW.TEST_TRUNC_PERSONS
AS
v_trunc_tbl_sql_full_text VARCHAR2(150);
BEGIN   
    v_trunc_tbl_sql_full_text := 'TRUNCATE TABLE TRW.PERSONS_BAKHIS_BAKHIS';
    DBMS_OUTPUT.PUT_LINE('v_trunc_tbl_sql_full_text: ' || v_trunc_tbl_sql_full_text);
    EXECUTE IMMEDIATE v_trunc_tbl_sql_full_text;
END;
/

CREATE PUBLIC SYNONYM TEST_TRUNC_PERSONS FOR TRW.TEST_TRUNC_PERSONS;
GRANT EXECUTE ON TEST_TRUNC_PERSONS TO DBLINK;
